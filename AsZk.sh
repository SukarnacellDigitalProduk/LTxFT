...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/LunaticBackend/LTxFT/main/"
start=$(date +%s)
secs_to_human() {
...
wget "http://raw.githubusercontent.com/LunaticBackend/LTxFT/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh"
cd
